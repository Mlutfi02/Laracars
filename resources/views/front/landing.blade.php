...
<body>
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light"
                    ...
                    <div class="navbar-nav w-100">
                        <div class="nav-item dropdown dropright">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Cars <i
                                    class="fa fa-angle-right float-right mt-1"></i></a>
                            <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                <a href="" class="dropdown-item">Toyota</a>
                                <a href="" class="dropdown-item">Daihatsu</a>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Cars</span>
                        <span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">Rental</span>
                    </a>
        ...
        <div class="row px-xl-5">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-relative w-100 h-100"
                                src="{{ asset('images/products_models/' . $products_models[2]->image) }}" style="object-fit: cover;">
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="{{ asset('images/products_models/LogoEiger.jpg') }}"
    ...
    <!-- <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            @foreach ($category_models as $itemcategory)
                    ...
                    <a class="text-decoration-none" href="">
                        <div class="cat-item d-flex align-items-center mb-4">
                            ...
                            <div class="flex-fill pl-3">
                                <h6>{{ $itemcategory->category_name }}</h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ asset('images/products_models/' . $item->image) }}" height="300"
                                alt="">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate overflow:hidden"
        ...
        <div class="row px-xl-5">
            ...
            @foreach ($products_models as $item)
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ asset('images/products_models/' . $item->image) }}"
                                alt="">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href=""><i
                                        class="fa fa-shopping-cart"></i></a>
